            ...
            <div class="col-md-6" style="padding-top: 25px;">
                ...
                <div class="step form-group">
                    ...
                    <label class="ea-label col-sm-4 control-label">
                        <?php esc_html(__($this->options->get_option_value('trans.location'), 'easy-appointments')); ?>
                    </label>
                    <div class="col-sm-8">
                ...
                <div class="step form-group">
                    <div class="block"></div>
                    <label class="ea-label col-sm-4 control-label">
                        <?php esc_html(__($this->options->get_option_value("trans.service"), 'easy-appointments')); ?>
                    </label>
                    <div class="col-sm-8">
                ...
                <div class="step form-group">
                    <div class="block"></div>
                    <label class="ea-label col-sm-4 control-label">
                        <?php esc_html(__($this->options->get_option_value("trans.worker"), 'easy-appointments')); ?>
                    </label>
                    <div class="col-sm-8">
