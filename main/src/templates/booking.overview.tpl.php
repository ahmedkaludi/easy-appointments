<script type="text/template" id="ea-appointments-overview">
    <div style="max-width: 500px; margin: 20px auto; padding: 20px; background-color: #e6f6e6; border-radius: 10px; text-align: center; font-family: Arial, sans-serif; box-shadow: 0 0 10px rgba(0, 0, 0, 0.05);" class="ea-confirmation-card">
        <h2 style="color: #147514; margin-top: 0;" class="ea-confirmation-title">
            <%- settings['trans.confirmation-title'] || 'Thank You for Booking!' %>
        </h2>
        <p style="margin: 10px 0 20px; font-size: 15px; color: #333;" class="ea-confirmation-subtext">
        ...
        <a href="#" style="display: inline-block; padding: 10px 20px; background-color: #28a745; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;" class="ea-button-book-again">
