...
(function ($) {
    ...
    $(function () {
        ...
        $(document).on('click', '.ea-mnui-delete-row', function () {
            var id = $(this).closest('tr').data('id');
            if (window.confirm(i18n.confirmDelete || 'Are you sure you want to delete this customer?')) {
                deleteCustomer(id);
            }
        });
        ...
        $('.ea-mnui-delete-all').on('click', function (e) {
            e.preventDefault();
            if (window.confirm(i18n.confirmDeleteAll || 'This will delete ALL customers. Are you sure?')) {
                deleteAllCustomers();
            }
        });
