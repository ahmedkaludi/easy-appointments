<script type="text/template" id="ea-appointments-overview">
    <div style="max-width: 500px; margin: 20px auto; padding: 20px; background-color: #e6f6e6; border-radius: 10px; text-align: center; font-family: Arial, sans-serif; box-shadow: 0 0 10px rgba(0, 0, 0, 0.05);" class="ea-confirmation-card">
        <h3 style="color: #147514; margin-top: 0; display:none;" class="ea-confirmation-title">
        ...
        <a href="#" onclick="window.location.reload();" style="display: none; padding: 10px 20px; background-color: #28a745; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;" class="ea-button-book-again">
